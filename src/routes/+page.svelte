  ...
  <div class="flex space-x-4 items-start">
    <div class="flex flex-col space-y-6">
      ...
      <p class="text-text font-medium">
        Garant Predmetu <span class="text-accent"
          >Ing. Roman Kazička, CSc., PhD.</span
        >
      </p>
    </div>
  </div>
  ...
  >
    {#each members as [name, slug, picture]}
      ...
      >
        ...
        <div
          class="absolute z-20 bottom-0 inset-x-0 p-2 md:p-4 pt-10 bg-gradient-to-t from-black/80 via-black/50 to-transparent"
        >
